...
class _$CharactersStateTearOff {
  ...
  _DataCharactersState data(
      {required List<ViewModel> characterList, required bool isGrid}) {
...
mixin _$CharactersState {
  @optionalTypeArgs
  TResult when<TResult extends Object?>({
    required TResult Function(List<ViewModel> characterList, bool isGrid) data,
    required TResult Function() initial,
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>({
    TResult Function(List<ViewModel> characterList, bool isGrid)? data,
    TResult Function()? initial,
...
abstract class _$DataCharactersStateCopyWith<$Res> {
  ...
  $Res call({List<ViewModel> characterList, bool isGrid});
}
...
class _$_DataCharactersState implements _DataCharactersState {
  ...
  /// Параметры
  final List<ViewModel> characterList;
  @override
  final bool isGrid;
...
abstract class _DataCharactersState implements CharactersState {
  const factory _DataCharactersState(
      {required List<ViewModel> characterList,
      required bool isGrid}) = _$_DataCharactersState;

  /// Параметры
  List<ViewModel> get characterList => throw _privateConstructorUsedError;
  bool get isGrid => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  _$DataCharactersStateCopyWith<_DataCharactersState> get copyWith =>
      throw _privateConstructorUsedError;
